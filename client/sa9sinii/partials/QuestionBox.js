        ...
        <div >
            <div className="Question_info">
               ...
               <div className="question_section">
                <p className="question" onClick={getQuestion}>{props.Question}</p>
                ...
                <Row className="info_row d-flex align-items-center ">
                    ...
                    <div className="col-4 col-sm-3 ml-auto"><button className="btn btn_answer" onClick={()=>router.push(`/questions/${props.id}/answerQuestion`)}>Answer</button></div>  
                 </Row>  
                </div>
